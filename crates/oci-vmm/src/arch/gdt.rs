...
// Ported into oci-vmm from Firecracker (src/vmm/src/arch/x86_64/gdt.rs), trimmed of metrics/snapshot/ACPI.

//! GDT entry construction and conversion to KVM segment descriptors.
