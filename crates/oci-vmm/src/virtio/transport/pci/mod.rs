...
// Ported into oci-vmm from Firecracker (src/vmm/src/devices/virtio/transport/pci/mod.rs), trimmed of metrics/snapshot/MMIO.

//! The modern (non-transitional) virtio-pci transport.

/// The virtio common configuration structure of the PCI transport
pub mod common_config;
/// The virtio-pci device itself
pub mod device;
